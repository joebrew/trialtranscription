# Variation of textAreaInput, based on : https://stackoverflow.com/questions/40808889/a-dynamically-resizing-shiny-textareainput-box

text_area_input <- function (inputId, label, value = "", width = NULL, height = NULL, 
